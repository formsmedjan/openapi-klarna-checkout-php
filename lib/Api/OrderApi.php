...
namespace FormsmedjanKlarnaCheckout\Api;
...
use FormsmedjanKlarnaCheckout\HeaderSelector;
...
class OrderApi
{
     ...
     * Create a new order
     *
     * @param  \FormsmedjanKlarnaCheckout\Model\Order $body body (optional)
     *
     * @throws \FormsmedjanKlarnaCheckout\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \FormsmedjanKlarnaCheckout\Model\Order
     */
     ...
     * Create a new order
     *
     * @param  \FormsmedjanKlarnaCheckout\Model\Order $body (optional)
     *
     * @throws \FormsmedjanKlarnaCheckout\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \FormsmedjanKlarnaCheckout\Model\Order, HTTP status code, HTTP response headers (array of strings)
     */
    public function createOrderMerchantWithHttpInfo($body = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\FormsmedjanKlarnaCheckout\Model\Order' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\FormsmedjanKlarnaCheckout\Model\Order', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\FormsmedjanKlarnaCheckout\Model\Order';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FormsmedjanKlarnaCheckout\Model\Order',
